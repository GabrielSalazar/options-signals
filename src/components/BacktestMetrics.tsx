...
export default function BacktestMetrics({ metrics }: BacktestMetricsProps) {
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="bg-slate-900 border-slate-800">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-slate-400">Risk Metrics</CardTitle>
                    <TrendingDown className="h-4 w-4 text-orange-500" />
                </CardHeader>
                <CardContent>
                    <div className="text-2xl font-bold text-slate-100">{metrics.sharpe_ratio} <span className="text-sm text-slate-500 font-normal">Sharpe</span></div>
